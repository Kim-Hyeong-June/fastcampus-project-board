...
class UserAccountServiceTest {
    ...
    void givenExistentUserId_whenSearching_thenReturnsOptionalUserData() {
        ...
        BDDMockito.given(userAccountRepository.findById(username))
                .willReturn(Optional.of(createUserAccount(username, username)));
    ...
    void givenUserParams_whenSaving_thenSavesUserAccount() {
        ...
        BDDMockito.given(userAccountRepository.save(userAccount)).willReturn(savedUserAccount);
    ...
    private UserAccount createUserAccount(String username , String createdBy) {
        return UserAccount.of(username, "password", "e@mail.com", "nickname", "memo", createdBy);
    }
